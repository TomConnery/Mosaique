...
import de.tomconn.mosaique.api.mosaique.MosaiqueBulkMethods;
import de.tomconn.mosaique.api.mosaique.MosaiqueVarargMethods;
 ...
 *
 * @param <R> The return type of {@link #parse(JsonObject)}
 * @param <M> The return type of {@link KeyModule#parse(JsonStructure)}
 *
 * @since 0.0.1
 */
public interface Mosaique< R, M > extends MosaiqueBulkMethods< M >, MosaiqueVarargMethods< M > {
    ...
    @HasBulk
    @HasVararg
    Optional< KeyModule< ?, M > > getModuleForKey(String key);
    ...
    @HasBulk
    @HasVararg
    Optional< List< String > > getKeysForModule(KeyModule< ?, M > module);
     ...
     */
    @HasBulk
    boolean registerModuleForKey(String key, KeyModule< ?, M > module);
    ...
    @HasBulk
    @HasVararg
    Optional< KeyModule< ?, M > > unregisterKey(String key);
    ...
    @HasBulk
    @HasVararg
    Optional< List< String > > unregisterModule(KeyModule< ?, M > module);
     ...
     */
    @HasBulk
    boolean forceRegister(String key, KeyModule< ?, M > module);
